      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-ocean-primary to-ocean-light h-full rounded-full opacity-30"></div>
            ...
            <div className="space-y-12">
              ...
              <div className="relative flex items-center">
                  ...
                  <Card className="hover:shadow-wave transition-all duration-300 border-ocean-light/20 bg-card/80 backdrop-blur-sm">
                    <CardHeader>
                      <div className="flex items-center justify-end gap-2 mb-2">
                        <span className="bg-ocean-primary text-white px-3 py-1 rounded-full text-sm font-medium">
                          In Progress
                        </span>
                      </div>
                      <CardTitle className="text-xl text-ocean-deep">M1 - Master's Degree Year 1</CardTitle>
                      <p className="text-ocean-primary font-semibold">
                        ISPM
                      </p>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground font-medium mb-2">August 2025 - Present</p>
                ...
                {/* Timeline dot */}
                <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-ocean-primary rounded-full border-4 border-background shadow-lg z-10"></div>
